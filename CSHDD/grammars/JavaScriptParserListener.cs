...
public interface IJavaScriptParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterOptionalChainExpression([NotNull] JavaScriptParser.OptionalChainExpressionContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>OptionalChainExpression</c>
	/// labeled alternative in <see cref="JavaScriptParser.singleExpression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitOptionalChainExpression([NotNull] JavaScriptParser.OptionalChainExpressionContext context);
	/// <summary>
