...
public partial class JavaScriptParser : JavaScriptParserBase {
	...
	private bool singleExpression_sempred(SingleExpressionContext _localctx, int predIndex) {
		switch (predIndex) {
		case 8: return Precpred(Context, 46);
		...
		case 26: return Precpred(Context, 45);
		case 27: return Precpred(Context, 44);
		case 28: return Precpred(Context, 41);
		case 29: return Precpred(Context, 39);
		case 30: return this.notLineTerminator();
		case 31: return Precpred(Context, 38);
