...
// Generated from C:/Users/Spodermen/RiderProjects/CSHDD/CSHDD/grammars\JavaScriptParser.g4 by ANTLR 4.10.1
...
public partial class JavaScriptParserBaseListener : IJavaScriptParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterEmptyStatement_([NotNull] JavaScriptParser.EmptyStatement_Context context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="JavaScriptParser.emptyStatement_"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitEmptyStatement_([NotNull] JavaScriptParser.EmptyStatement_Context context) { }
	/// <summary>
	...
	/// <summary>
	/// Enter a parse tree produced by the <c>OptionalChainExpression</c>
	/// labeled alternative in <see cref="JavaScriptParser.singleExpression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterOptionalChainExpression([NotNull] JavaScriptParser.OptionalChainExpressionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by the <c>OptionalChainExpression</c>
	/// labeled alternative in <see cref="JavaScriptParser.singleExpression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitOptionalChainExpression([NotNull] JavaScriptParser.OptionalChainExpressionContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterAnonymousFunctionDecl([NotNull] JavaScriptParser.AnonymousFunctionDeclContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitAnonymousFunctionDecl([NotNull] JavaScriptParser.AnonymousFunctionDeclContext context) { }
	/// <summary>
