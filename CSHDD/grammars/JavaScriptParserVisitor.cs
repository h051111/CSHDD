...
public interface IJavaScriptParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitOptionalChainExpression([NotNull] JavaScriptParser.OptionalChainExpressionContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitAnonymousFunctionDecl([NotNull] JavaScriptParser.AnonymousFunctionDeclContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitLet_([NotNull] JavaScriptParser.Let_Context context);
	/// <summary>
