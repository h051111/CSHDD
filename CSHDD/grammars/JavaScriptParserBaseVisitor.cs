...
public partial class JavaScriptParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IJavaScriptParserVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitOptionalChainExpression([NotNull] JavaScriptParser.OptionalChainExpressionContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitAnonymousFunctionDecl([NotNull] JavaScriptParser.AnonymousFunctionDeclContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="JavaScriptParser.let_"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitLet_([NotNull] JavaScriptParser.Let_Context context) { return VisitChildren(context); }
	/// <summary>
